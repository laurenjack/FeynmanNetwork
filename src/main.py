...
tf.set_random_seed(61664)
np.random.seed(5763378)

sizes = [784, 60, 10]
learning_rate = 0.01
m = 20
epochs = 20
conf = Config(sizes, learning_rate, m, epochs, feyn_lr=0.05, feyn_epochs=100, k=15, epsilon=0.025, is_binary=False)#/255.0)
...
human_classifer.run(network, train_region_set, conf, sess, test_samples=60)
