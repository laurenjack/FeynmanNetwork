...
class SimpleLogistic:
    ...
    def __init__ (self, conf):
        ...
        self.y = tf.placeholder(dtype=tf.float32, shape=[None], name="target")
        #Define the logistic regression model
        self.W = tf.get_variable("W_simple_logitstic", shape=[NUM_INPUTS, 1], initializer=tf.contrib.layers.xavier_initializer())
